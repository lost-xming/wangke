...
const mapDispatch = (dispatch) => {
	return {
		getList: dispatch.my2.getList,
		getWeiXinPay: dispatch.my2.getWeiXinPay,
		getZhiFuBaoPay: dispatch.my2.getZhiFuBaoPay,
		getHostory: dispatch.my2.getHostory,
	};
};
const mapState = (state) => {
	return {
		userInfo: state.my2.userInfo,
		carList: state.my2.carList,
		dataSource: state.my2.dataSource,
	};
};
